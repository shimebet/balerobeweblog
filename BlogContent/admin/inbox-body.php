    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
                ...
                <div class="inbox-body">
                    <div class="heading-inbox row">
                        <div class="col-md-8">
                            ...
                            <a class="btn btn-sm btn-primary" href="mail_compose.php?email=<?= $row['email'] ?>&subject=<?= urlencode($row['subject']) ?>"><i class="fa fa-share"></i> Reply</a>
            ...
            <div class="collapse" id="collapseExample">
                ...
                Living the good life sometimes feels like a cliché, but enjoying the little things is important. Whether it's hanging out with friends, trying new foods, or doing creative projects, it's these moments that make life special and meaningful.
                </div>
            </div>
        </div>
    </div>
