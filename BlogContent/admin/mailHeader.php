...
<div class="mail-box">
    <aside class="sm-side">
        <div class="user-head">
            ...
            <div class="user-name">
                <h5><a href="#">Bale Robe Secondary High School</a></h5>
                <span><a href="#">balerobe@gmail.com</a></span>
            </div>
        ...
        <ul class="inbox-nav inbox-divider">
            ...
            <li <?= $page == 'draft.php' ? 'class="active"' : '' ?>>
                <a href="draft.php"><i class=" fa fa-link"></i> Draft <span class="badge badge-info float-right mt-3">10</span></a>
            </li>
